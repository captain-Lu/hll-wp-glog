Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/captain-Lu/hll-wp-glog"
  s.license      = { :type => "Apache 2.0", :file => "LICENSE.TXT"}

  s.ios.deployment_target = "9.0"

  s.source       = { :git => "https://github.com/captain-Lu/hll-wp-glog.git", :tag => "v#{s.version}" }
  s.source_files =  "iOS/Glog/Glog/*.{h,m,mm}"
  s.public_header_files = "iOS/Glog/Glog/*.h"

  s.framework    = "CoreFoundation"
  s.libraries    = "z", "c++"
  s.dependency 'GlogCore', :git => "https://github.com/HuolalaTech/hll-wp-glog.git", :tag => '1.0.2'
